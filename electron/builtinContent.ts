...
const WORLD_BOOK_TUTOR: WorldBook = {
  ...
  entries: [
    ...
    { id: 'wb-tutor-4', key: '语音', constant: false, content: '语音 / TTS 多协议（v2.3.22）：Base URL 自动识别协议，已支持 OpenAI 兼容、MiniMax(t2a_v2)、Google Gemini、ElevenLabs、Fish Audio、字节火山、Azure、AWS Polly、腾讯云、百度、阿里通义 qwen-tts、Cartesia。音色列表自动从厂商接口拉取，无列表 API 的厂商直接手填——软件不内置任何音色/模型清单，模型与音色留空会明确提示补填；字节/Polly/腾讯/百度需在 API Key 栏填 `ID:Secret` 双凭据；按角色可配独立语音 API 与音色。' },
